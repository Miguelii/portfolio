...
- **Effect**: a powerful TypeScript framework that provides a fully-fledged functional effect system
- **Sanity** as headless CMS with an embedded Studio at `/studio`
- **Three.js** with React Three Fiber, Drei, and Rapier for 3D Card Band
