...
export default function Project({title,projectUrl,imageUrl,techStack}:ProjectProps) {

    return (
        <Link href={projectUrl} prefetch={false} target='_blank'>
            <CardContainer className="inter-var w-full cursor-pointer" containerClassName="w-full">
            ...
            <div className="flex flex-col gap-8 md:flex-row md:justify-between md:pl-20">
                ...
                <div className="flex flex-col gap-6 items-center md:items-start">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <span className="font-mono text-sm">Tech Stack: Next.js | Typescript | Tailwind | Supabase | CrafterCMS</span>
