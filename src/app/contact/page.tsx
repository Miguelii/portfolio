...
export default function ContactPage() {
  return (
    ...
    <h1 className="font-mono text-base md:text-lg xl:text-xl uppercase font-semibold text-start relative z-20 bg-clip-text text-transparent bg-gradient-to-b from-white/75 via-white to-white">
